...
class HotelManagementSystem:
    def __init__(self, root):
        ...
        img1 = img1.resize((1300,140),Image.LANCZOS)
        self.photoimg1=ImageTk.PhotoImage(img1)

        lblimg = Label(self.root,image=self.photoimg1,bd=4,relief=RIDGE)
        lblimg.place(x=85,y=0,width=1600,height=140)
        ...
        ################ Title ##################
        lbl_title = Label(self.root,text="Hotel Management System",font=("oswald",40,"bold"),bg="#141a23",fg="#84693b",bd=4,relief=RIDGE)
        ...
        ############### LABEL ################
        lbl_menu = Label(main_frame,text="MENU",font=("times new roman",20,"bold"),bg="Brown",fg="Yellow",bd=4,relief=RIDGE)
        ...
        img3 = img3.resize((1379,590),Image.LANCZOS)
        self.photoimg3=ImageTk.PhotoImage(img3)

        lblimg1 = Label(main_frame,image=self.photoimg3,bd=4,relief=RIDGE)
        lblimg1.place(x=230,y=0,width=1370,height=541)
